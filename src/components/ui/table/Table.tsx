...
const DynamicTable = <T extends UuidId, U>({ columns, data, setData, name }: TableProps<T, U>) => {
  ...
  return (
    <div className="w-full border rounded-lg">
      <table className="min-w-full min-h-12 block border-collapse border border-gray-300 bg-white overflow-auto">
      ...
      {/* <button className="mt-4 w-full bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600" onClick={addRow}>
        + Add Row
      </button> */}
    </div>
  );
